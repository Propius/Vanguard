...
public class GameSalesSpecification {
  ...
  public static Specification<GameSales> buildSpecification(
      LocalDate fromDate, LocalDate toDate, BigDecimal salePrice, FilterType filterType) {
      ...
      if (fromDate != null) {
        predicates.add(
            criteriaBuilder.greaterThanOrEqualTo(
                criteriaBuilder.function("DATE", LocalDate.class, root.get("dateOfSale")),
                fromDate));
      }
      if (toDate != null) {
        predicates.add(
            criteriaBuilder.lessThanOrEqualTo(
                criteriaBuilder.function("DATE", LocalDate.class, root.get("dateOfSale")), toDate));
      }
